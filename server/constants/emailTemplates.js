...
exports.documentEmailTemplate = ({ ...data }) => {
  ...
  return `<!DOCTYPE html>
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Catamaran:wght@800&family=Roboto:wght@500&display=swap"
            rel="stylesheet">
        <title></title>
        <style type="text/css">
    ...
    <body style="margin: 1em; padding: 0; -webkit-text-size-adjust: 100%; color: #000000;">
        <div style="margin: 1px;">
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tbody>
                    <tr>
                        <td style="padding: 1em !important">
                            <table bgcolor="#7c0e0e" border="0" cellpadding="0" cellspacing="0" align="center"
                                style="width: 680px; background-color: #e5e5e5">
                                <tbody>
                                    <tr>
                                        <td style="
                                          width: 100%;
                                        ...
                                        ">
                                          ...
                                          <a href="https://mymanager.com" target="_blank">
                                          <img style="width: 200px; height: 62px" src="${MYMANAGERLOGO}"
                                                  alt="My Member" />
                                          </a>
                                          </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td
                                            style="background-color: #d6d6d6; padding-left: 67px; padding-right: 53px; text-align: center; align-items: center;">
                                            <p style="
                                              margin-top: 32px;
