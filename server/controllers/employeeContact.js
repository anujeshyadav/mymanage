...
const contactAdd = asyncHandler(async (req, res) => {
  const { fullName, username, address, city, role, email, phone, position, password, state, willSendEmail, zip, outletId } = req.body;

  let hashedPassword = "", permissionInfo;
                ...
                <div
                    ...
                    <div style='padding: 10px; font-size: 12px;'>
                        <p style='color: #1b1a1a;'>
                            ...
                            <br>
                            <br>
                            <u>${req.user.fullName ? req.user.fullName : req.user.firstName + ' ' + req.user.lastName}</u> has invited you to their team, in a workspace called
                            Mymanager.
                            <br>
                            <br>
                            <span>Just Click: </span>https://mymanager.com/employee/activate/${newEmployeeContact._id}
                        </p>
                    </div>
