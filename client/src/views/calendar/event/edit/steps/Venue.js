...
const Address = ({ stepper, type, eventForm, eventInfo }) => {
  ...
  useEffect(() => {
    ...
    setValue('eventLocation', eventInfo.eventLocation);
    setValue('eventState', eventInfo.eventState);
    setValue('eventCity', eventInfo.eventCity);
    setValue('eventStreet', eventInfo.eventStreet);
