...
const SubmitReplyModal = ({ modal, setModal, toggle, _id, guestInfo }) => {
    ...
    const handleChange = (e) => {
        setState((p) => ({ ...p, replyType: document.querySelector('input[name="replyType"]:checked').value }));
    }
    // Handle submit
    const handleSubmit = (event) => {
        ...
        dispatch(addUpdateGuests({ _id: _id, guestData: state, isNewEmployee: isNewEmployee }));
                    ...
                    <div className="mb-1">
                        <Form onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="d-flex">
                                <input type="radio" id="accept" name="replyType" value="accept" onChange={handleChange} defaultChecked />
                                <label htmlFor="accept" className="ps-50 pe-1">Yes</label>
                                <input type="radio" id="no" name="replyType" value="no" onChange={handleChange} />
                                <label htmlFor="no" className="ps-50 pe-1">No</label>
                                <input type="radio" id="maybe" name="replyType" value="maybe" onChange={handleChange} />
