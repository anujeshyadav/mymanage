  ...
  const list = () => (
    <div style={{ width: 280 }}>
      <div className="accordion" style={{ borderRadius: 'none' }}>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              ...
              {['attachment','checkbox','company','drawing','dropdown','initial','radio','sign','stamp','text','title'].includes(selectedItem?.type) && (
                <FormGroup check>
                  <Input
                    name="required"
                    type="checkbox"
        ...
        {['text', 'company', 'note', 'formula', 'title'].includes(selectedItem?.type) && (
          <div className="accordion-item">
        ...
        {[
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                {['sign', 'initial', 'stamp'].includes(selectedItem?.type) && (
                  <div className="row">
                    <div className="col-6">
                      <Input
                        type="text"
