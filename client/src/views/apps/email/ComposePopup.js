...
const ComposePopup = (props) => {
  // ** Props & Custom Hooks
  const { composeOpen, toggleCompose, metadata, contactsStore } = props;
                ...
                <Row className="px-1 mb-1">
                  ...
                  <Col xl="3">
                    <Input
                      ...
                      value={toType}
                    >
                      <option value="smartlist">Smart List</option>
                      <option value="email">Email</option>
                    </Input>
                  </Col>
                  <Col xl="4" className={`${toType == 'smartlist' && 'd-none'}`}>
                    <div style={formGroupStyleOverrides}>
                  ...
                  <Col xl="4" className={`${toType == 'email' && 'd-none'}`}>
